...
class OllamaClient:
    ...
    async def generate_async(self, model: str, prompt: str, stream: bool = False,
    ...
    async def chat_async(self, model: str, messages: List[Dict[str, str]], stream: bool = False,
                        options: Optional[Dict[str, Any]] = None) -> Any:
        ollama_messages = [OllamaMessage(**msg) for msg in messages]
        request = OllamaChatRequest(
            model=model,
    ...
    async def _stream_response_async(self, response: httpx.Response) -> AsyncIterator[Dict[str, Any]]:
    ...
    async def embeddings_async(self, model: str, prompt: str) -> OllamaEmbeddingResponse:
