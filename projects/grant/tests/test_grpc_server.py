...
class TestGRPCServer:
    ...
    def test_get_probabilities_single_request(self, servicer, mocker):
        ...
        mock_result.answer = "This is a test answer about inflation and economic conditions."
