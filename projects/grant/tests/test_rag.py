...
class TestRAGPipeline:
    ...
    def test_pipeline_initialization(self, mock_chunker, mock_embedding, mock_vector_store, 
                                   temp_dir, mock_ollama_client):
    ...
    @patch('grant.rag.EmbeddingService')
    @patch('grant.rag.PodcastChunker')
    def test_index_transcription(self, mock_chunker_class, mock_embedding_class, 
                                mock_vector_store_class, mock_db, mock_ollama_client,
        ...
        mock_metadata = TranscriptionMetadata.from_row({
            "id": 123, "filename": "test.mp3", "file_hash": "hash",
            "language": "en", "full_text": "text", "model_name": "whisper",
            "created_at": "2024-01-01", "feed_url": None, "feed_item_id": None,
            "feed_item_title": None, "feed_item_published": None
        })
        mock_db.get_transcription_metadata.return_value = mock_metadata
        mock_db.get_segments_for_transcription.return_value = mock_transcription_result.segments
        ...
        mock_chunker.chunk_transcription.assert_called_once_with(mock_metadata, mock_transcription_result.segments)
    ...
    @patch('grant.rag.EmbeddingService')
    @patch('grant.rag.PodcastChunker')
    def test_index_all_transcriptions(self, mock_chunker_class, mock_embedding_class,
                                    mock_vector_store_class, mock_db, mock_ollama_client,
                                    mock_transcription_result):
        ...
        mock_transcriptions = [
            TranscriptionMetadata.from_row({
                "id": 1, "filename": "test1.mp3", "file_hash": "hash1",
                "language": "en", "full_text": "text1", "model_name": "whisper",
                "created_at": "2024-01-01", "feed_url": None, "feed_item_id": None,
                "feed_item_title": None, "feed_item_published": None
            }),
            TranscriptionMetadata.from_row({
                "id": 2, "filename": "test2.mp3", "file_hash": "hash2",
                "language": "en", "full_text": "text2", "model_name": "whisper",
                "created_at": "2024-01-01", "feed_url": None, "feed_item_id": None,
                "feed_item_title": None, "feed_item_published": None
            })
        ]
    ...
    @patch('grant.rag.EmbeddingService')
    @patch('grant.rag.PodcastChunker')
    def test_query(self, mock_chunker_class, mock_embedding_class,
                  mock_vector_store_class, mock_db, mock_ollama_client):
        ...
        mock_vector_store.search.return_value = [
            (TextChunk(
                ...
                metadata={"transcription_id": "123", "start_time": 0.0, "end_time": 10.0}
            ), 0.9),
            (TextChunk(
                id="123_1",
                text="Deep learning is a subset of machine learning...",
                metadata={"transcription_id": "123", "start_time": 10.0, "end_time": 20.0}
            ), 0.8)
        ]
        mock_vector_store_class.return_value = mock_vector_store
        ...
        mock_metadata = TranscriptionMetadata.from_row({
            "id": 123, "filename": "podcast.mp3", "file_hash": "hash",
            "language": "en", "full_text": "full text", "model_name": "whisper",
            "created_at": "2024-01-01", "feed_url": None, "feed_item_id": None,
            "feed_item_title": "ML Podcast", "feed_item_published": "2024-01-01"
        })
        mock_db.get_transcription_metadata.return_value = mock_metadata
    ...
    @patch('grant.rag.EmbeddingService')
    @patch('grant.rag.PodcastChunker')
    def test_query_no_results(self, mock_chunker_class, mock_embedding_class,
                             mock_vector_store_class, mock_db, mock_ollama_client):
        ...
        assert result.answer == "I couldn't find any relevant information in the podcast transcriptions to answer your question."
    ...
    @patch('grant.rag.EmbeddingService')
    @patch('grant.rag.PodcastChunker')
    def test_delete_transcription(self, mock_chunker_class, mock_embedding_class,
                                 mock_vector_store_class, mock_db, mock_ollama_client):
