...
class TestPodcastVectorStore:
    ...
    def test_add_chunks(self, mock_chroma_client):
        ...
        assert call_args['documents'] == ["First chunk about neural networks", 
    ...
    def test_search(self, mock_chroma_client):
        ...
        mock_collection.query.return_value = {
            ...
            'documents': [['Neural networks...', 'Deep learning...', 'Machine learning...']],
            'metadatas': [[
