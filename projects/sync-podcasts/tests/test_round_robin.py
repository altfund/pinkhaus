...
class TestRoundRobin:
    ...
    def test_round_robin_processing(
        self,
        temp_dir,
        ...
        assert (
            mock_rag_pipeline.return_value.index_all_transcriptions.call_count
    ...
    def test_date_threshold_filtering(
        self,
        temp_dir,
        mock_transcription_service,
        mock_ollama_client,
    ...
    def test_daemon_mode_exit(
        ...
        with patch("time.sleep") as mock_sleep:
            ...
            with patch.object(
                syncer, "process_one_podcast", return_value=False
            ) as mock_process:
