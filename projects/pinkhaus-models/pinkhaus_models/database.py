...
class TranscriptionDatabase(_TranscriptionDatabase):
    ...
    def get_recent_transcriptions(self, limit: int = 10, metadata_table: str = "transcription_metadata") -> List[Dict[str, Any]]:
    ...
    def get_full_transcription(self, transcription_id: int, metadata_table: str = "transcription_metadata", segments_table: str = "transcription_segments") -> Optional[Dict[str, Any]]:
