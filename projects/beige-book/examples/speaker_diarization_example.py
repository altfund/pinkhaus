...
from beige_book.speaker_diarizer import create_speaker_aware_transcription, SpeakerDiarizer
...
def example_with_mock_diarization():
    ...
    audio_file = "path/to/your/podcast.wav"
...
def example_with_real_diarization():
    ...
    if not hf_token:
        print("Note: For real speaker diarization, you need:")
        ...
        print("3. Install pyannote-audio (currently has issues with Python 3.13)")
        return
    ...
    try:
        ...
        print(f"Error: {e}")
        print("\nFalling back to mock diarization example...")
...
if __name__ == "__main__":
    ...
    # Try real diarization (if available)
