...
import torch
import torchaudio
from .proto_models import TranscriptionResult
...
class VoiceEmbeddingExtractor:
    ...
    def extract_embeddings_for_speaker(
        self, audio_path: str, segments: List[Dict[str, any]], min_duration: float = 3.0
    ...
    def extract_embeddings_for_transcription(
        ...
        """
        if not transcription_result.has_speaker_labels:
            return {}
