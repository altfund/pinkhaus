...
class DatabaseIO:
        ...
        for metadata in all_transcriptions:
            ...
            export_item = {
                ...
                "metadata": {
                    ...
                    "feed_item_published": metadata.feed_item_published.isoformat()
    ...
    def import_from_json(
        self, input_path: str, skip_duplicates: bool = True
    ) -> Dict[str, int]:
        """
    ...
    def export_transcription_to_json(
        self, transcription_id: int, output_path: str
    ) -> bool:
        """
    ...
    def export_transcription_to_toml(
        self, transcription_id: int, output_path: str
    ) -> bool:
        """
