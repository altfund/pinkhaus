...
def main():
    ...
    export_parser = subparsers.add_parser(
        "export", help="Export transcriptions from database"
    )
    ...
    export_parser.add_argument(
        "--id", type=int, help="Export single transcription by ID"
    )

    # Import command
    import_parser = subparsers.add_parser(
        "import", help="Import transcriptions to database"
    )
    ...
    import_parser.add_argument(
        "--force", action="store_true", help="Import duplicates (default: skip)"
    )
