...
class TestTranscriptionDatabase:
    ...
    def test_save_transcription(self, temp_db, sample_result):
        ...
        # Check metadata
        cursor.execute(
            "SELECT * FROM transcription_metadata WHERE id = ?", (transcription_id,)
        )
        row = cursor.fetchone()
    ...
    def test_custom_table_names(self, temp_db, sample_result):
        ...
        data = db.get_transcription(
            transcription_id, metadata_table="my_metadata", segments_table="my_segments"
        )
...
class TestDatabaseIntegration:
    ...
    def test_real_transcription_storage(self, temp_db, harvard_result):
        ...
        assert (
            ...
            == "971b4163670445c415c6b0fb6813c38093409ecac2f6b4d429ae3574d24ad470"
        )
